...
***/
  ...
  console.log("MaestroIOBoard: this.pins: " + this.pins);
  ...
  this.emit("ready");
	...
	if (onReady) {
    console.log("MaestroIOBoard: invoking onReady");
		onReady(this);
	}
}
...
// per ioboard/README.md
util.inherits(MaestroIOBoard, IOBoard)
...
MaestroIOBoard.prototype.servoWrite = function( pin, degrees ) {
    ...
    function(x) { 
      // console.log("write rcv: " + util.inspect(x));
    });
};

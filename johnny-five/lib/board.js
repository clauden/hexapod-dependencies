...
console.log("out of order ready");
          isPostponed = true;
        } else {
...
function broadcast(err, type, io) {
  ...
  console.log("Broadcast got " + type);

  // Assign found io to instance
  if (!this.io) {
    console.log("assigning IO: " + util.inspect(io));
    this.io = io;
  }
...
Board.Component = function(opts, componentOpts) {
  ...
  console.log("Board.Component(" + opts +", "+componentOpts);
...
Object.assign(Board.Array.prototype, Collection.prototype);
